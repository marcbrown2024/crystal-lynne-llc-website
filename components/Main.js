...
const Main = () => {
  return (
    <div
      id="main"
      className="breakpoint w-full h-screen flex flex-col space-y-8 items-center justify-center text-center border-b-2 border-slate-200 overflow-hidden"
    >
      ...
      <div className="skewdiv w-full absolute -z-10 top-[10%] bg-[#bebbbb38] left-0 h-[600px] lg:h-[700px] -skew-y-3"></div>
    </div>
  );
};
